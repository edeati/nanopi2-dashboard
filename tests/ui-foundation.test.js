...
module.exports = async function run() {
  ...
  assert.ok(html.indexOf('transform: scale(1.08);') > -1, 'radar gif should zoom in further to remove right-side banding');
  ...
  assert.ok(html.indexOf('function smoothSeries(') > -1, 'generated line smoothing helper missing');
  assert.ok(html.indexOf("ctx.strokeStyle = '#f2bb3c';") > -1, 'generated hybrid line color missing');
  assert.ok(html.indexOf('ctx.lineWidth = 3;') > -1, 'generated hybrid line should be thicker');
