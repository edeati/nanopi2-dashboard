...
module.exports = async function run() {
  ...
  assert.ok(html.indexOf("solarChartImage.src = '/api/solar/chart.svg?rev=5&mode=' + (ready ? 'ready' : 'pending') + '&slot=' + (bucket % 2) + '&iso=' + isoPoints + '&err=' + (isFinite(isoErr) ? isoErr : 0);") > -1, 'solar chart should alternate bounded no-store URLs');
