...
module.exports = async function run() {
  ...
  assert.ok(html.indexOf("ctx.fillStyle = '#ff6b3d';") > -1, 'usage bars should use orange-red import fill');
  ...
  assert.ok(html.indexOf("ctx.strokeStyle = '#ffb347';") > -1, 'generated hybrid line color should stay distinct from import bars');
