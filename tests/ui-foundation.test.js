...
module.exports = async function run() {
  ...
  assert.ok(html.indexOf("src += (src.indexOf('?') > -1 ? '&' : '?') + 'strict=1';") > -1, 'forced gif reload should request strict latest gif');
  ...
  assert.ok(html.indexOf('loadRadarGif(true);') > -1, 'realtime gif updates should force a reload even when pending');
